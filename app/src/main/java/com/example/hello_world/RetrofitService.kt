...
class ToDo(
    val id: Int, val created: String, val content: String, val is_complete: Boolean
)
...
interface RetrofitService {
    ...
    @POST("instagram/post/")
    fun uploadPost(
        @HeaderMap headers: Map<String,String>, //사용자의 정보
        @Part image: MultipartBody.Part, // 이미지 용량이 크니 쪼개서 보낸다.
        @Part("content") content: RequestBody
    ): Call<Any>

    @POST("instagram/post/like/{post_id}/") //중괄호 안에는 변수다.
    fun postLike(
